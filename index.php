...
$query = 'SELECT customers.customerID, customers.emailAddress, customers.firstName, customers.lastName, addresses.line1, addresses.phone, addresses.city, addresses.zipCode, addresses.state FROM customers
INNER JOIN addresses ON customers.customerID = addresses.customerID 
GROUP BY customerID, emailAddress, firstName, lastName, line1, phone,city, zipCode; ';// PUT YOUR SQL QUERY HERE
